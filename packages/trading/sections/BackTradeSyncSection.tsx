...
import { load_stock_json, ModelToCandle, sleep, STORAGE_KEY } from '../utils';
...
export type BackTradeResult = [string, ResultGroup]
...
async function backTrade(data_all:any[], setter:(data_all:any[])=>void, resultSetter:(result:BackTradeResult[])=>void, show_log:number, context:typeof backTradeContext){
  ...
  if (condition && context.sync_lock == 0){
    ...
    let earn = 0
    let stocks:any = {}
    resultSetter(Object.entries(preResult.reduce((prev, data)=>{
